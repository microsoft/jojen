...
class Sparse extends FlagRule {
    compile(params) {
        const allow = params.args[0] === undefined ? true : params.args[0];
        this.invokeLast(params, ArrayValidator, (r) => { r._allowSparse = allow; });
    }
...
class Single extends FlagRule {
    compile(params) {
        const allow = params.args[0] === undefined ? true : params.args[0];
        this.invokeLast(params, ArrayValidator, (r) => { r._allowSingle = allow; });
    }
